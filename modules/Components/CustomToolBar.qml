...
ToolBar {
    ...
    RowLayout {
        ...
        AwesomeToolButton {
            ...
            onClicked: {toolBarConfig && toolBarConfig.toolButton1 ? toolBarConfig.toolButton1.action() : console.log(appWindow.stacks[currentIndex]) }
        }
        AwesomeToolButton {
            id: toolButton2
            ...
            onClicked: {toolBarConfig && toolBarConfig.toolButton2 && Object.keys(toolBarConfig.toolButton2).length > 0 ? toolBarConfig.toolButton2.action() : console.log("nada no botao 2") }
        }
        Label {
